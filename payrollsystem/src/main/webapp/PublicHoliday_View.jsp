...
<div class="flex flex-col h-screen justify-center items-center">
        <div class="w-full md:w-1/3 bg-white rounded shadow-lg p-8 m-4">
            ...
            <form name="frmPublicHolidayAdd" method="get">
                <div class="mb-4">
                    <label for="txtPublicHolidayId" class="block text-gray-700 text-sm font-bold mb-2">PublicHoliday Id</label>
                    <input type="text" name="txtPublicHolidayId" id="txtPublicHolidayId" value="<%= pdto.getPhId() %>" disabled
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="txtPublicHolidayName" id="txtPublicHolidayName" value="<%= pdto.getPhName() %>" disabled
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
                <div class="mb-4">
                    <label for="txtPublicHolidayDescription" class="block text-gray-700 text-sm font-bold mb-2">PublicHoliday
                        Description</label>
                    <input type="text" name="txtPublicHolidayDesc" id="txtPublicHolidayDesc" value="<%= pdto.getPhDescription() %>" disabled
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
